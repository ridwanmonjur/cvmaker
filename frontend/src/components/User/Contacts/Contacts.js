          ...
          <div className="row">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="row">
                  <div className="col text-center text-md-left mt-3">
                    ...
                    {loading && (
                      <div
                        className="spinner-border text-primary-2"
                        role="status"
                      >
            ...
            <div className="col-md-3 text-center">
              <ul className="list-unstyled mb-0">
                <li>
                  <i className="fa fa-map-marker fa-lg text-primary-2 "></i>
                  <p>{user?.address || "Add address"}</p>
                </li>
                <li>
                  <i className="fa fa-phone fa-lg mt-4 text-primary-2"></i>
                  <p>{user?.phone || "Your phone"}</p>
                </li>
                <li>
                  <i className="fa fa-envelope fa-lg mt-4 text-primary-2"></i>
